...
All the images of the prediction are available in the vis repository and the `prediction_explanation.pdf` file will give you some information about the prediction process.  
